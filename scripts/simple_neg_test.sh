...
# Self-Play Prompt Evolution for SimpleNegotiation
...
RANDOM_RATIO=0.75   # % random exploration
TRAJECTORY_RATIO=0.0 # % trajectory-based improvements
CROSSOVER_RATIO=0.0 # % crossover
...
TEMPERATURE=0.0 # Temperature for model sampling (0.0 for deterministic)
...
echo "Starting Prompt Evolution System"
echo "================================="
echo "Model: $MODEL"
...
echo "Evolution Ratios: Keep=$KEEP_RATIO, Random=$RANDOM_RATIO, Trajectory=$TRAJECTORY_RATIO, Crossover=$CROSSOVER_RATIO"
...
echo "Replay Merge Style: $REPLAY_MERGE_STYLE"
echo "Abstract Gen Style: $ABSTRACT_GEN_STYLE"
...
python -m mpr.self_play_prompt_evolution_memory \
    ...
    $SKIP_BASELINE_EVAL_FLAG
echo ""
echo "Prompt evolution complete!"
